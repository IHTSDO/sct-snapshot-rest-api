...
router.module.getV1Concepts=getV1Concepts;
router.module.getV1Concept=getV1Concept;
router.module.getV1Descriptions=getV1Descriptions;
router.module.getV1Description=getV1Description;
router.module.getV1ConceptDescriptors=getV1ConceptDescriptors;
router.module.getV1ConceptDescriptor=getV1ConceptDescriptor;
router.module.getV1Relationships=getV1Relationships;
router.module.getV1Relationship=getV1Relationship;
